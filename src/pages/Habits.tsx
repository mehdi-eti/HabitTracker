...
export default function Habits() {
	...
	const tabs = [
		...
		{ id: "archived", label: t("archived_habits") || "Archived" },
									...
									{activeTab === "archived" && (
										<>
											...
											<button
												...
												<ArchiveRestore size={18} /> {t("unarchive") || "Unarchive"}
											</button>
											<button
												onClick={() => handleDelete(habit.id)}
									...
									{activeTab === "completed" && (
										<>
											...
											<button
												...
												<Play size={18} /> {t("restart") || "Restart"}
											</button>
											<button
									...
									{activeTab === "deleted" && (
										<>
											<button
												...
												className='flex items-center gap-2 px-4 py-2.5 bg-slate-50 dark:bg-slate-800/50 text-slate-700 dark:text-slate-300 rounded-xl text-sm font-bold hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors'>
												<RotateCcw size={18} /> {t("restore") || "Restore"}
											</button>
											<button
